                ...
                <form action="#">
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      ...
                      type="text"
                      id="address"
                      defaultValue="K572/72 Ông Ích Khiêm"
                    />
                  </div>
                ...
                <form action="#">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center space-y-3">
                      ...
                      <p>
                        <span className="text-primary">Chọn hình ảnh</span>
                      </p>
                      <p className="mt-1.5">JPG, JPEG, PNG</p>
                    </div>
                  </div>
